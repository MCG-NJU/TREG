...
def run(settings):
    ...
    settings.search_area_factor = 4.5
    ...
    settings.logging_file = 'fcot_log_vot.txt'
    ...
    # dataset_train = sampler.FCOTSampler([lasot_train, got10k_train, trackingnet_train, coco_train], [0.1,1,1,1],
    #                                     samples_per_epoch=settings.samples_per_epoch, max_gap=50, num_test_frames=3, num_train_frames=3,
    #                                     processing=data_processing_train)
    dataset_train = sampler.FCOTSampler([got10k_train],
                                        [1],
                                        samples_per_epoch=10000, max_gap=50, num_test_frames=1,
                                        num_train_frames=1,
                                        processing=data_processing_train)
    ...
    dataset_val = sampler.FCOTSampler([got10k_val], [1], samples_per_epoch=5000, max_gap=50, num_test_frames=3,
    ...
    lr_scheduler = optim.lr_scheduler.MultiStepLR(optimizer, milestones=[22, 30, 40], gamma=0.2)
