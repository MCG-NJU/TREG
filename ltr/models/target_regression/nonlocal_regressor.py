...
class NonlocalRegressor(nn.Module):
    ...
    def __init__(self, filter_size, feature_stride=4, feature_extractor=None):
        super().__init__()
        ...
        self.filter_pool = FilterPool(filter_size=self.filter_size, feature_stride=feature_stride, pool_square=False)
    ...
    def regress(self, train_feat, train_bb, test_feat):
        ...
        # offset_maps = self.head(test_feat)
        offset_maps = offset_maps.view(-1, num_sequences, 4, *offset_maps.size()[-2:])
