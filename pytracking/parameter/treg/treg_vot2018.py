...
def parameters():
    ...
    params.image_sample_size = 14*16 # 18 * 16
    params.search_area_scale = 4.2   # 4.2
    ...
    params.net_opt_iter_72 = 25  # 12 16
    ...
    params.lamda_72 = 0.55
    params.lamda_18 = 1
    # params.reg_lamda = 1

    params.reg_mem_size = 7 # best: 8 & 6

    ### multi-scale classification
    # params.merge_rate_72 = 0.4
    params.merge_rate_18 = 0.7
    ...
    params.net = NetWithBackbone(net_path='treg_vot.pth',
