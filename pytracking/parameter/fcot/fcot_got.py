...
def parameters():
    ...
    params.search_area_scale = 4.7

    params.sample_memory_size = 50
    params.learning_rate = 0.01
    params.init_samples_minimum_weight = 0.2
    ...
    params.target_not_found_threshold = 0.08
    params.distractor_threshold = 0.6
    params.hard_negative_threshold = 0.5
    params.target_neighborhood_scale = 1.2
    ...
    params.net = NetWithBackbone(net_path='fcot_online_reg_v2.pth', use_gpu=params.use_gpu)
