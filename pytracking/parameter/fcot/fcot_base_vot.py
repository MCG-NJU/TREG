...
def parameters():
    ...
    # regressor
    params.reg_init_train_iter = 0 #6
    params.reg_net_opt_iter = 0 #4
    params.reg_net_opt_hn_iter = 0
    params.reg_net_opt_update_iter = 0 #1

    ### merge the initial model and the optimized model.
    params.lamda_72 = 0.5
    params.lamda_18 = 1.0
    params.reg_lamda = 0.6 #0.6
    ...
    params.net = NetWithBackbone(net_path='fcot_ablation_cls19_2s_ep33.pth', #'fcot_base_ep57.pth', #'fcot.pth',
