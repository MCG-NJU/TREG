...
class EnvSettings:
    def __init__(self):
        ...
        fcot_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../..'))

        self.results_path = '{}/tracking_results/'.format(pytracking_path)
        self.network_path = '{}/models/'.format(fcot_path)
        self.otb_path = ''
        self.tpl_path = ''
        self.nfs_path = ''
        self.uav_path = ''
        ...
        self.packed_results_path='{}/tracking_results/'.format(pytracking_path)
